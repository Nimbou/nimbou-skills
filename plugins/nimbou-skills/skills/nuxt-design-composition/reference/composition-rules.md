# Nuxt Design — Composition: regras

Referência de consulta de `nuxt-design-composition`. Leia depois de escrever o Working Model e antes de montar a sequência da página.
