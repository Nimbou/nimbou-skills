...
description: "Create or evolve a Nuxt page, layout, or route wiring that composes existing components and composables: page-level state, route meta, layout choice, SEO/meta."
model: sonnet
color: pink
memory: project
---
