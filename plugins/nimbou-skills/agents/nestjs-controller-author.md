...
description: "Wire HTTP transport for an existing use-case: controller, HTTP DTOs, guards, validation pipes, module composition. Coordination only, no business logic."
model: haiku
color: yellow
memory: project
---
